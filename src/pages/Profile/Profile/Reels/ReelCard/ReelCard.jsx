...
import Liked from "../../../../../components/Icons/Like/Like";
import Commented from "../../../../../components/Icons/Comment/Comment";
    ...
    <>
      {reelsData.map((reel) => (
        <Link
          to="/"
          key={reel.id}
          className="lg:w-[24.675%] md:w-[32.5%] w-[32.5%] lg:h-[48vh] md:h-[40vh] sm:h-[35vh] h-[30vh] relative group"
          style={{
